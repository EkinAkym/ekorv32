...
//----------------------------------------------------------------------//
    ...
    // Wires between Memory Control Unit and Memory //
        wire mem_en_w;
        wire mem_we_w;
        wire [`A11:`A0] mem_addr_w;
        wire [`RVLENM1:`RVLEN0] mem_data_i_w;
        wire [`RVLENM1:`RVLEN0] mem_data_o_w;
        wire mem_ready_w;
        wire mem_data_ready_w;
...
//----------------------------------------------------------------------//
    ...
    ekorv32_core_mem_ctrl_unit MEM_CTRL(
        ...
        .mem_data_i(mem_data_o_w),
        .mem_ready_i(mem_ready_w),
        .mem_data_ready_i(mem_data_ready_w),
        .mem_en_o(mem_en_w),
        .mem_we_o(mem_we_w),
        .mem_addr_o(mem_addr_w),
        .mem_data_o(mem_data_i_w)
    );
...
//============================== ASSIGNS ===============================//
//----------------------------------------------------------------------//
    assign rv32_result_o = rv32_result_w;
    assign pc_o = alu_lpc_w;
//----------------------------------------------------------------------//
//=============================== NOTES ================================//
//----------------------------------------------------------------------//
endmodule
