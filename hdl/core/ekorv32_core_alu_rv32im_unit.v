...
//  Change Log   : 08.06.2025 | E.Akyildirim | v1.01
                    ...
                    `OPCODE_OP: begin
                        ...
                        if(alu_func_i[`ALU_FUNC7_MSB:`ALU_FUNC7_LSB] == `F7_OP_M_EXT) begin
                            if(alu_func_i[`ALU_FUNC3_MSB] == `RV1B0) begin
                                ...
                                end else if (mul_delay_reg == `A3) begin
                                ...
                                end else if (div_delay_reg == `A3) begin
